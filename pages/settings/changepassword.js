        ...
        <Layout>
            ...
            >
                ...
                >
                    ...
                    <Button onClick={() => { router.push("./feedback") }} className="mr-auto navigationButton" variant="text" size="small" fullWidth>
                    ...
                    <Box id="profileBox"
                        ...
                        <Box id="profileDetailContainerBox">
                            ...
                            <Box className="profileDetailsBox" display='flex'>
                                ...
                                <input disabled id="username" type="text" name="username" className="detailsInput"></input>
                            </Box>

                            <Box className="profileDetailsBox" display='flex'>
                                <Typography
                                    className="details">EMAIL:</Typography>
                                <input disabled id="email" type="text" name="email" className="detailsInput"></input>
                            </Box>

                            <Box className="profileDetailsBox" display='flex'>
                                <Typography
                                    className="details">COUNTRY:</Typography>
                                <input disabled id="country" type="text" name="country" className="detailsInput"></input>
                            </Box>
                        </Box>

                        <Box id="passwordBox">
                            <Typography className="passwordLabel">*CURRENT PASSWORD</Typography>
                            <input id="oldPassword" type="password" className="password" size={50} required></input>
                            <Typography className="passwordLabel">*NEW PASSWORD</Typography>
                            <input id="newPassword" type="password" className="password" size={50} required></input>
                            <Typography className="passwordLabel">*CONFIRM NEW PASSWORD</Typography>
                            <input id="confirmNewPassword" type="password" className="password" size={50} required></input>
                            <Button onClick={handleOnClick} id="saveButton" variant="contained">
                                Save
                            </Button>
                        </Box>
                    </Box>
