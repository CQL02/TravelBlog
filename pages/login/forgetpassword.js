        ...
        <div>
            ...
            <div className="rounded-2xl shadow-2xl bg-blue-200 flex w-2/3 max-w-4xl">
                ...
                <div className="flex flex-col items-center mb-3">
                    ...
                    <input type="OTP" name="OTP" placeholder="OTP" className="bg-gray-100 outline-none text-sm flex-1"/>
                    <p className="text-xs">request verification</p>
                    </div>

                <div>
                <a href="#" className="rounded-full inline-block font-bold bg-gray-100 w-64 p-2 flex items-center">VERIFY</a>
                </div>
