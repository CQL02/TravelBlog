    ...
    return(
        <div>
            ...
            <div className="rounded-2xl shadow-2xl bg-blue-200 flex w-2/3 max-w-4xl">
                ...
                <div className="bg-gray-100 w-64 p-2 flex items-center rounded-2xl">
                    <HttpsIcon className="m-2 "/>
                    <input type="Confirm Password" name="Confirm Password" placeholder="Confirm Password" className="bg-gray-100 outline-none text-sm flex-1"/>
                    <VisibilityIcon className="m-2"/>
                    </div>

                <div>
                <a href="#" className="rounded-full inline-block font-bold bg-gray-100 w-64 p-2 flex items-center">CREATE</a>
                </div>
